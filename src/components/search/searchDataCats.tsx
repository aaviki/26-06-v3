...
import { UrlCatInterface } from "../../interfaces/urlCatInterface";
import { dataCatsService } from "../../services/dataCatsSevice";
// import { Cat } from "../Cat";

export function SearchDataCats() {
